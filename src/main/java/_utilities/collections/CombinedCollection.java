...
public class CombinedCollection<E> implements Collection<E> {
	...
	public CombinedCollection(Collection<? extends E>... iter) {
		sets = ImmutableSet.copyOf(iter);
	}

	public CombinedCollection(Iterable<? extends Collection<? extends E>> iter) {
		sets = ImmutableSet.copyOf(iter);
	}

	public CombinedCollection(Iterator<? extends Collection<? extends E>> iter) {
		sets = ImmutableSet.copyOf(iter);
	}
	...
	public Iterator<E> iterator() {
		return sets.parallelStream().flatMap(Collection::stream).map((a) -> (E) a).iterator();
	}
