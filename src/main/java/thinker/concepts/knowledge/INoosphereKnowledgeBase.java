 ...
 * knowledge, the noosphere maintains the collective knowledge of many
...
public interface INoosphereKnowledgeBase extends IKnowledgeBase {
	 ...
	 * @return
	 */
	public IRelationGraph<? extends IGroupConceptNode, IConceptRelationType> getConceptGraphView();
